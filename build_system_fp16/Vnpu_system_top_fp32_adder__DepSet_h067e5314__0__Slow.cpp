...
VL_ATTR_COLD void Vnpu_system_top_fp32_adder___ctor_var_reset(Vnpu_system_top_fp32_adder* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vnpu_system_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vnpu_system_top_fp32_adder___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__large_mant = VL_RAND_RESET_I(24);
    vlSelf->__PVT__small_mant = VL_RAND_RESET_I(24);
    vlSelf->__PVT__exp_diff = VL_RAND_RESET_I(8);
    vlSelf->__PVT__a_is_larger = VL_RAND_RESET_I(1);
    vlSelf->__PVT__aligned_small = VL_RAND_RESET_I(27);
    vlSelf->__PVT__sticky_bit = VL_RAND_RESET_I(1);
    vlSelf->__PVT__mant_sum = VL_RAND_RESET_I(28);
    vlSelf->__PVT__norm_exp = VL_RAND_RESET_I(8);
    vlSelf->__PVT__norm_mant = VL_RAND_RESET_I(27);
    vlSelf->__PVT__lzc = VL_RAND_RESET_I(5);
