...
module axi_lite_mmio_bridge #(
    ...
    output logic                      mmio_drain_start,
    output logic [8:0]                mmio_drain_len,

    // --- MMIO Input from npu_system_top ---
    input  logic                      mmio_dma_done,
    input  logic                      mmio_npu_done,
    input  logic                      mmio_drain_done
);
        ...
        if (!rst_n) begin
            ...
            if (s_axil_arvalid && s_axil_arready) begin
                ...
                case (s_axil_araddr[4:2])
                    ...
                    3'h1: s_axil_rdata <= {29'd0, mmio_drain_done, mmio_npu_done, mmio_dma_done};
                    ...
                    3'h6: s_axil_rdata <= {7'd0, mmio_drain_len, mmio_npu_seq_len};
