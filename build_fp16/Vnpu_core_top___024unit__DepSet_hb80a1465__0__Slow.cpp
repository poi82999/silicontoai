...
VL_ATTR_COLD void Vnpu_core_top___024unit___ctor_var_reset(Vnpu_core_top___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vnpu_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vnpu_core_top___024unit___ctor_var_reset\n"); );
}
