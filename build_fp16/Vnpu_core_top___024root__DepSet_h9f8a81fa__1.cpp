...
VL_INLINE_OPT void Vnpu_core_top___024root___ico_sequent__TOP__2(Vnpu_core_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vnpu_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnpu_core_top___024root___ico_sequent__TOP__2\n"); );
    // Body
